...
object My_Main {
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("file:///C://Users//Daria//Desktop//PythonProjects//2020.12.01_parse_html//languages2.csv").map { idx => idx.toLowerCase }
    val junk = data.first()
...
//    val startTime = LocalDateTime.now()
    ...
    val posts = sc.textFile("file:///C://Users//Daria//Desktop//big_data//data//posts_sample.xml")
//    val posts = sc.textFile("file:///E://stackexchange//Posts.xml")
//
...
//    spark.createDataset(yearAndTags).write.parquet("post_dataset")
    ...
    res.write.format("parquet").save("languages_full.parquet")
